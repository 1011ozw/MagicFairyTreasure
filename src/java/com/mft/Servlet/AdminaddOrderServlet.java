...
public class AdminaddOrderServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("Price") != "") {
            Order o = new Order();
            //userID,userName,address,Price,type
            o.setUid(Integer.parseInt(request.getParameter("userID")));
            o.setUsername(request.getParameter("userName"));
            o.setAddress(request.getParameter("address"));
            o.setCost(request.getParameter("Price"));
            o.setType(Integer.parseInt(request.getParameter("type")));
